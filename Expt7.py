...
class PuzzleState:
    def __init__(self, board, moves=0, previous=None):
        ...
        self.zero_pos = board.index(0)  # This will give the position of 0 (empty space).
...
if __name__ == "__main__":
    initial = [int(x) for x in input("Enter the initial state (9 numbers 0-8): ")]
    goal = [int(x) for x in input("Enter the goal state (9 numbers 0-8): ")]
